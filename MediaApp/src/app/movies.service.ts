   ...
   movies: Movie[] = [
    {
      ...
      plot: `Princess Leia is captured and held hostage by the evil Imperial
    ...
    },
    {
      ...
      plot: `Thirty years after defeating the Galactic Empire, Han Solo and his
              allies face a new threat from the evil Kylo Ren and his army of Stormtroopers.`,
      year: 2015,
    },
    {
      id: 3,
    ...
    },
    {
      ...
      plot:
        `Through a series of daring escapades deep within a dark and dangerous
          criminal underworld, Han Solo meets his mighty future copilot Chewbacca and
          encounters the notorious gambler Lando Calrissian.`,
      year: 2018,
    },
    {
      id: 5,
      ...
      plot: `The next installment in the franchise, and the conclusion of the
